...
//   BASE_PRECISION,
//   ONE,
//   DEFAULT_MARKET_NAME, getDriftStateAccountPublicKeyAndNonce, DRIFT_PROGRAM_ID, TestClient,
// } from '@drift-labs/sdk';
// import {
//   createUserWithUSDCAccount,
//   initializeQuoteSpotMarket, mockOracle,
//   mockUSDCMint,
//   mockUserUSDCAccount,
//   printTxLogs, sleep,
// } from './testHelpers';
...
//   const driftProgram = anchor.workspace.Drift;
//
...
//       },
//     });
//     managerUSDCAccount = await mockUserUSDCAccount(usdcMint, usdcAmount, provider, manager.publicKey);
...
//   //     vd.publicKey
//   //   );
//   //   // todo: get VaultDepositor and Vault and assert fields
//   // });
//   //
